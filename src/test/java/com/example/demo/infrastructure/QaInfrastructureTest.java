...
public class QaInfrastructureTest {
    ...
    private static final String SNS_TOPIC_NAME = "s3-events-qa";
    private static final String SQS_QUEUE_NAME = "image-processing-queue-qa";
    ...
    public void testSnsTopicHealth() {
        try (SnsClient snsClient = SnsClient.builder()
            ...
            var qaTopic = listTopicsResponse.topics().stream()
